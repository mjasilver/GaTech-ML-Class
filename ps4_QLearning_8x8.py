...
#                    start_exploration_rate=1.0,end_exploration_rate=0.01, decay='exponential')
    #Linear Decay
    q_learning(game="FrozenLake-v0",num_episodes=10000,max_timesteps=1000,learning_rate=0.1,discount_rate=0.99,exploration_rate=1,exploration_decay_rate=0.001,
                    start_exploration_rate=1.0,end_exploration_rate=0.01, decay='exponential',enhanced_exploitation=True)
    return

    

def q_learning(game="FrozenLake-v0",num_episodes=10000,max_timesteps=100,learning_rate=0.1,discount_rate=0.99,exploration_rate=1,exploration_decay_rate=0.001,
